  ...
  return (
    <HqFrame active="/hq/settings">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <section className="card p-4"><div className="overline mb-2">Your data</div><SeedAndData seededAt={settings?.seededAt?.toISOString() ?? null} counts={{ pipelines, relationships, ideas, notes }} /></section>
